                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                ...
                                ?>
                                <div class="card-body">
                                    <form action="?controller=song&action=store&admin=1" method="post" enctype="multipart/form-data">
                                        
                                        <div class="position-relative row form-group">
                                            <label for="song" class="col-md-3 text-md-right col-form-label">Song</label>
                                            <div class="col-md-9 col-xl-8">
                                                <input required="" name="song" id="song" placeholder="song" type="file" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="image" class="col-md-3 text-md-right col-form-label">Image</label>
                                            <div class="col-md-9 col-xl-8">
                                                <input required="" name="image" id="image" placeholder="image" type="file" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required="" name="price" id="price" placeholder="price" type="number" class="form-control" value="">
                                            </div>
                                        </div>
