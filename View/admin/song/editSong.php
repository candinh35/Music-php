                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                ...
                                ?>
                                <div class="card-body">
                                    <form action="?controller=song&action=update&admin=1&id=<?php echo $song['id'] ?>" method="post" enctype="multipart/form-data">
                                        <div class="position-relative row form-group">
                                            <label for="song" class="col-md-3 text-md-right col-form-label">Song</label>
                                            <div class="col-md-9 col-xl-8">
                                                <input name="song" id="song" placeholder="song" type="file" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                ...
                                                <img src="<?php echo 'uploads/' . $song['image'] ?>" alt="">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="name" class="col-md-3 text-md-right col-form-label">Name</label>
                                            <div class="col-md-9 col-xl-8">
                                                <input required="" name="name" id="name" placeholder="Name" type="text" class="form-control" value="<?php echo $song['name'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required="" name="price" id="price" placeholder="price" type="number" class="form-control" value="<?php echo $song['price'] ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <select required="" name="singer_id" id="singer_id" class="form-control">
                                                    ...
                                                    <?php foreach ($singers as $singer) : ?>
                                                        <option value="<?php echo $singer['id'] ?>" <?php echo $song['singer_id'] == $singer['id'] ? 'selected' : '' ?>>
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <select required="" name="genre_id" id="genre_id" class="form-control">
                                                    ...
                                                    <?php foreach ($genres as $genre) : ?>
                                                        <option value="<?php echo $genre['id'] ?>" <?php echo $song['genre_id'] == $genre['id'] ? 'selected' : '' ?>>
                                                            <?php echo $genre['name'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="position-relative row form-group mb-1">
                                            <div class="col-md-9 col-xl-8 offset-md-2">
                                                <a href="?controller=song&action=index&admin=1" class="border-0 btn btn-outline-danger mr-1">
