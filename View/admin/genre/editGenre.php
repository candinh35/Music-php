                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-card mb-3 card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="?controller=genre&action=update&admin=1&id=<?php echo  $genre['id']?>" method="post"
                                      enctype="multipart/form-data">
                                    <div class="position-relative row form-group">
                                        <label for="name" class="col-md-3 text-md-right col-form-label">Name</label>
                                        <div class="col-md-9 col-xl-8">
                                            <input required="" name="name" id="name" placeholder="Name" type="text"
                                                   class="form-control" value="<?php echo  $genre['name']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <textarea name="description" id="" cols="30" rows="10"  class="form-control"><?php echo  $genre['description']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-relative row form-group mb-1">
                                        <div class="col-md-9 col-xl-8 offset-md-2">
                                            <a href="?controller=genre&action=index&admin=1"
