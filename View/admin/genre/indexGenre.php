                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a href="?controller=genre&action=create&admin=1"
                            ...
                            <div class="table-responsive">
                                <table class="align-middle mb-0 table table-borderless table-striped table-hover text-center">
                                    ...
                                    <?php foreach ($genres as $genre): ?>
                                        <tr>
                                            <td class="text-center text-muted"><?php echo $genre['id'] ?></td>
                                            <td class="text-center text-muted"><?php echo $genre['name'] ?></td>
                                            <td class="text-center text-muted"><?php echo $genre['description'] ?></td>

                                            <td class="text-center">
                                                <a href="?controller=genre&action=edit&admin=1&id=<?php echo $genre['id'] ?>"
                                                ...
                                                <a class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                                   href="?controller=genre&action=delete&admin=1&id=<?php echo $genre['id'] ?>"
                                                   type="submit"
