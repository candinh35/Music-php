                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-card mb-3 card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="?controller=singer&action=update&admin=1&id=<?php echo  $singer['id']?>" method="post"
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <img style="height: 200px; cursor: pointer;"
                                                 ...
                                                 src="<?php echo $singer['avata_url'] != null ?  'uploads/' . $singer['avata_url'] : 'template/admin/assets/images/add-image-icon.jpg' ?>"
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <input required="" name="name" id="name" placeholder="Name" type="text"
                                                   class="form-control" value="<?php echo  $singer['name']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <textarea name="description" id="" cols="30" rows="10"  class="form-control"><?php echo  $singer['description']?></textarea>
                                        </div>
                                    </div>
