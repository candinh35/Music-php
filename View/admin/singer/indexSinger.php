                            ...
                            <div class="table-responsive">
                                <table class="align-middle mb-0 table table-borderless table-striped table-hover text-center">
                                    ...
                                    <?php foreach ($singers as $singer): ?>
                                        <tr>
                                            <td class="text-center text-muted"><?php echo $singer['id'] ?></td>
                                            <td class="text-center text-muted"><?php echo $singer['name'] ?></td>
                                            <td class="text-center text-muted"><img width="100" src="<?php echo 'uploads/' . $singer['avata_url'] ?>" alt=""> </td>
                                            <td class="text-center text-muted"><?php echo $singer['description'] ?></td>

                                            <td class="text-center">
                                                <a href="?controller=singer&action=edit&admin=1&id=<?php echo $singer['id'] ?>"
                                                ...
                                                <a class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                                   href="?controller=singer&action=delete&admin=1&id=<?php echo $singer['id'] ?>"
                                                   type="submit"
