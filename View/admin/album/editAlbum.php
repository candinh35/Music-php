                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-card mb-3 card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="?controller=album&action=update&admin=1&id=<?php echo  $album['id']?>" method="post"
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <img style="height: 200px; cursor: pointer;"
                                                 ...
                                                 src="<?php echo $album['image_url'] != null ?  'uploads/' . $album['image_url'] : 'template/admin/assets/images/add-image-icon.jpg' ?>"
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <input required="" name="name" id="name" placeholder="Name" type="text"
                                                   class="form-control" value="<?php echo  $album['name']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-relative row form-group mb-1">
                                        <div class="col-md-9 col-xl-8 offset-md-2">
                                            <a href="?controller=album&action=index&admin=1"
