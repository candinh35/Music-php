                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a href="?controller=album&action=create&admin=1"
                            ...
                            <div class="table-responsive">
                                <table class="align-middle mb-0 table table-borderless table-striped table-hover text-center">
                                    ...
                                    <?php foreach ($albums as $album): ?>
                                        <tr>
                                            <td class="text-center text-muted"><?php echo $album['id'] ?></td>
                                            <td class="text-center text-muted"><?php echo $album['name'] ?></td>
                                            <td class="text-center text-muted"><img width="100" src="<?php echo 'uploads/' . $album['image_url'] ?>" alt=""> </td>
                                            <td class="text-center text-muted"><?php echo $album['description'] ?></td>

                                            <td class="text-center">
                                                <a href="?controller=album&action=edit&admin=1&id=<?php echo $album['id'] ?>"
                                                ...
                                                <a class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                                   href="?controller=album&action=delete&admin=1&id=<?php echo $album['id'] ?>"
                                                   type="submit"
